function createConnectedScatterPlot(data) {
    ...
    const svgScatter = d3.select("#connectedScatterChart")
        .append("svg")
    ...
    const yAxisScatter = d3.axisLeft(yScaleScatter).ticks(5);
    ...
    const line = d3.line()
        .x(d => xScaleScatter(+d.releaseYear))
        .y(d => yScaleScatter(+d.rating));
